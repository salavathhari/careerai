...
-- AddForeignKey
ALTER TABLE "public"."User" ADD CONSTRAINT "User_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "public"."IndustryInsight"("id") ON DELETE SET NULL ON UPDATE CASCADE;
